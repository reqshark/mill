...
fs.readFile(libsodium_dir + "/Makefile", 'utf8', function (err, make) {
  ...
  d = d.replace(/\\/g, '');
  fs.readFile("libsodium.gyp.in", 'utf8', function (err, template) {
    console.log("Libsodium GYP template file " + "libsodium.gyp.in");
    ...
    fs.writeFile("libsodium.gyp", result, 'utf8', function (err) {
       if (err) return console.log(err);
        console.log("Writing output to GYP file libsodium.gyp");
       return true;
    });
    return true;
  });
